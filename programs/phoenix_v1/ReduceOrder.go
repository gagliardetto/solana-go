...
// ReduceOrder is the `ReduceOrder` instruction.
...
// NewReduceOrderInstructionBuilder creates a new `ReduceOrder` instruction builder.
func NewReduceOrderInstructionBuilder() *ReduceOrder {
	nd := &ReduceOrder{
...
func (inst *ReduceOrder) SetParams(params ReduceOrderParams) *ReduceOrder {
	inst.Params = &params
	return inst
}

// SetPhoenixProgramAccount sets the "phoenixProgram" account.
func (inst *ReduceOrder) SetPhoenixProgramAccount(phoenixProgram ag_solanago.PublicKey) *ReduceOrder {
	inst.AccountMetaSlice[0] = ag_solanago.Meta(phoenixProgram)
	return inst
}

// GetPhoenixProgramAccount gets the "phoenixProgram" account.
func (inst *ReduceOrder) GetPhoenixProgramAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(0)
}

// SetLogAuthorityAccount sets the "logAuthority" account.
func (inst *ReduceOrder) SetLogAuthorityAccount(logAuthority ag_solanago.PublicKey) *ReduceOrder {
	inst.AccountMetaSlice[1] = ag_solanago.Meta(logAuthority)
	return inst
}

// GetLogAuthorityAccount gets the "logAuthority" account.
func (inst *ReduceOrder) GetLogAuthorityAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(1)
}

// SetMarketAccount sets the "market" account.
func (inst *ReduceOrder) SetMarketAccount(market ag_solanago.PublicKey) *ReduceOrder {
	inst.AccountMetaSlice[2] = ag_solanago.Meta(market).WRITE()
	return inst
}

// GetMarketAccount gets the "market" account.
func (inst *ReduceOrder) GetMarketAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(2)
}

// SetTraderAccount sets the "trader" account.
func (inst *ReduceOrder) SetTraderAccount(trader ag_solanago.PublicKey) *ReduceOrder {
	inst.AccountMetaSlice[3] = ag_solanago.Meta(trader).SIGNER()
	return inst
}

// GetTraderAccount gets the "trader" account.
func (inst *ReduceOrder) GetTraderAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(3)
}

// SetBaseAccountAccount sets the "baseAccount" account.
func (inst *ReduceOrder) SetBaseAccountAccount(baseAccount ag_solanago.PublicKey) *ReduceOrder {
	inst.AccountMetaSlice[4] = ag_solanago.Meta(baseAccount).WRITE()
	return inst
}

// GetBaseAccountAccount gets the "baseAccount" account.
func (inst *ReduceOrder) GetBaseAccountAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(4)
}

// SetQuoteAccountAccount sets the "quoteAccount" account.
func (inst *ReduceOrder) SetQuoteAccountAccount(quoteAccount ag_solanago.PublicKey) *ReduceOrder {
	inst.AccountMetaSlice[5] = ag_solanago.Meta(quoteAccount).WRITE()
	return inst
}

// GetQuoteAccountAccount gets the "quoteAccount" account.
func (inst *ReduceOrder) GetQuoteAccountAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(5)
}

// SetBaseVaultAccount sets the "baseVault" account.
func (inst *ReduceOrder) SetBaseVaultAccount(baseVault ag_solanago.PublicKey) *ReduceOrder {
	inst.AccountMetaSlice[6] = ag_solanago.Meta(baseVault).WRITE()
	return inst
}

// GetBaseVaultAccount gets the "baseVault" account.
func (inst *ReduceOrder) GetBaseVaultAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(6)
}

// SetQuoteVaultAccount sets the "quoteVault" account.
func (inst *ReduceOrder) SetQuoteVaultAccount(quoteVault ag_solanago.PublicKey) *ReduceOrder {
	inst.AccountMetaSlice[7] = ag_solanago.Meta(quoteVault).WRITE()
	return inst
}

// GetQuoteVaultAccount gets the "quoteVault" account.
func (inst *ReduceOrder) GetQuoteVaultAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(7)
}

// SetTokenProgramAccount sets the "tokenProgram" account.
func (inst *ReduceOrder) SetTokenProgramAccount(tokenProgram ag_solanago.PublicKey) *ReduceOrder {
	inst.AccountMetaSlice[8] = ag_solanago.Meta(tokenProgram)
	return inst
}

// GetTokenProgramAccount gets the "tokenProgram" account.
func (inst *ReduceOrder) GetTokenProgramAccount() *ag_solanago.AccountMeta {
...
func (inst ReduceOrder) ValidateAndBuild() (*Instruction, error) {
...
func (inst *ReduceOrder) Validate() error {
...
func (inst *ReduceOrder) EncodeToTree(parent ag_treeout.Branches) {
	parent.Child(ag_format.Program(ProgramName, ProgramID)).
		//
		ParentFunc(func(programBranch ag_treeout.Branches) {
			programBranch.Child(ag_format.Instruction("ReduceOrder")).
				//
...
func (obj ReduceOrder) MarshalWithEncoder(encoder *ag_binary.Encoder) (err error) {
...
func (obj *ReduceOrder) UnmarshalWithDecoder(decoder *ag_binary.Decoder) (err error) {
	// Deserialize `Params`:
...
// NewReduceOrderInstruction declares a new ReduceOrder instruction with the provided parameters and accounts.
func NewReduceOrderInstruction(
	// Parameters:
	params ReduceOrderParams,
	// Accounts:
	...
	tokenProgram ag_solanago.PublicKey) *ReduceOrder {
	return NewReduceOrderInstructionBuilder().
		SetParams(params).
