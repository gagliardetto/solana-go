...
// SwapWithPriceImpact is the `swapWithPriceImpact` instruction.
...
// NewSwapWithPriceImpactInstructionBuilder creates a new `SwapWithPriceImpact` instruction builder.
func NewSwapWithPriceImpactInstructionBuilder() *SwapWithPriceImpact {
	nd := &SwapWithPriceImpact{
...
func (inst *SwapWithPriceImpact) SetAmountIn(amountIn uint64) *SwapWithPriceImpact {
	inst.AmountIn = &amountIn
	return inst
}

// SetActiveId sets the "activeId" parameter.
func (inst *SwapWithPriceImpact) SetActiveId(activeId int32) *SwapWithPriceImpact {
	inst.ActiveId = &activeId
	return inst
}

// SetMaxPriceImpactBps sets the "maxPriceImpactBps" parameter.
func (inst *SwapWithPriceImpact) SetMaxPriceImpactBps(maxPriceImpactBps uint16) *SwapWithPriceImpact {
	inst.MaxPriceImpactBps = &maxPriceImpactBps
	return inst
}

// SetLbPairAccount sets the "lbPair" account.
func (inst *SwapWithPriceImpact) SetLbPairAccount(lbPair ag_solanago.PublicKey) *SwapWithPriceImpact {
	inst.AccountMetaSlice[0] = ag_solanago.Meta(lbPair).WRITE()
	return inst
}

// GetLbPairAccount gets the "lbPair" account.
func (inst *SwapWithPriceImpact) GetLbPairAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(0)
}

// SetBinArrayBitmapExtensionAccount sets the "binArrayBitmapExtension" account.
func (inst *SwapWithPriceImpact) SetBinArrayBitmapExtensionAccount(binArrayBitmapExtension ag_solanago.PublicKey) *SwapWithPriceImpact {
...
func (inst *SwapWithPriceImpact) GetBinArrayBitmapExtensionAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(1)
}

// SetReserveXAccount sets the "reserveX" account.
func (inst *SwapWithPriceImpact) SetReserveXAccount(reserveX ag_solanago.PublicKey) *SwapWithPriceImpact {
	inst.AccountMetaSlice[2] = ag_solanago.Meta(reserveX).WRITE()
	return inst
}

// GetReserveXAccount gets the "reserveX" account.
func (inst *SwapWithPriceImpact) GetReserveXAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(2)
}

// SetReserveYAccount sets the "reserveY" account.
func (inst *SwapWithPriceImpact) SetReserveYAccount(reserveY ag_solanago.PublicKey) *SwapWithPriceImpact {
	inst.AccountMetaSlice[3] = ag_solanago.Meta(reserveY).WRITE()
	return inst
}

// GetReserveYAccount gets the "reserveY" account.
func (inst *SwapWithPriceImpact) GetReserveYAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(3)
}

// SetUserTokenInAccount sets the "userTokenIn" account.
func (inst *SwapWithPriceImpact) SetUserTokenInAccount(userTokenIn ag_solanago.PublicKey) *SwapWithPriceImpact {
	inst.AccountMetaSlice[4] = ag_solanago.Meta(userTokenIn).WRITE()
	return inst
}

// GetUserTokenInAccount gets the "userTokenIn" account.
func (inst *SwapWithPriceImpact) GetUserTokenInAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(4)
}

// SetUserTokenOutAccount sets the "userTokenOut" account.
func (inst *SwapWithPriceImpact) SetUserTokenOutAccount(userTokenOut ag_solanago.PublicKey) *SwapWithPriceImpact {
	inst.AccountMetaSlice[5] = ag_solanago.Meta(userTokenOut).WRITE()
	return inst
}

// GetUserTokenOutAccount gets the "userTokenOut" account.
func (inst *SwapWithPriceImpact) GetUserTokenOutAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(5)
}

// SetTokenXMintAccount sets the "tokenXMint" account.
func (inst *SwapWithPriceImpact) SetTokenXMintAccount(tokenXMint ag_solanago.PublicKey) *SwapWithPriceImpact {
	inst.AccountMetaSlice[6] = ag_solanago.Meta(tokenXMint)
	return inst
}

// GetTokenXMintAccount gets the "tokenXMint" account.
func (inst *SwapWithPriceImpact) GetTokenXMintAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(6)
}

// SetTokenYMintAccount sets the "tokenYMint" account.
func (inst *SwapWithPriceImpact) SetTokenYMintAccount(tokenYMint ag_solanago.PublicKey) *SwapWithPriceImpact {
	inst.AccountMetaSlice[7] = ag_solanago.Meta(tokenYMint)
	return inst
}

// GetTokenYMintAccount gets the "tokenYMint" account.
func (inst *SwapWithPriceImpact) GetTokenYMintAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(7)
}

// SetOracleAccount sets the "oracle" account.
func (inst *SwapWithPriceImpact) SetOracleAccount(oracle ag_solanago.PublicKey) *SwapWithPriceImpact {
	inst.AccountMetaSlice[8] = ag_solanago.Meta(oracle).WRITE()
	return inst
}

// GetOracleAccount gets the "oracle" account.
func (inst *SwapWithPriceImpact) GetOracleAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(8)
}

// SetHostFeeInAccount sets the "hostFeeIn" account.
func (inst *SwapWithPriceImpact) SetHostFeeInAccount(hostFeeIn ag_solanago.PublicKey) *SwapWithPriceImpact {
	inst.AccountMetaSlice[9] = ag_solanago.Meta(hostFeeIn).WRITE()
	return inst
}

// GetHostFeeInAccount gets the "hostFeeIn" account.
func (inst *SwapWithPriceImpact) GetHostFeeInAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(9)
}

// SetUserAccount sets the "user" account.
func (inst *SwapWithPriceImpact) SetUserAccount(user ag_solanago.PublicKey) *SwapWithPriceImpact {
	inst.AccountMetaSlice[10] = ag_solanago.Meta(user).SIGNER()
	return inst
}

// GetUserAccount gets the "user" account.
func (inst *SwapWithPriceImpact) GetUserAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(10)
}

// SetTokenXProgramAccount sets the "tokenXProgram" account.
func (inst *SwapWithPriceImpact) SetTokenXProgramAccount(tokenXProgram ag_solanago.PublicKey) *SwapWithPriceImpact {
	inst.AccountMetaSlice[11] = ag_solanago.Meta(tokenXProgram)
	return inst
}

// GetTokenXProgramAccount gets the "tokenXProgram" account.
func (inst *SwapWithPriceImpact) GetTokenXProgramAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(11)
}

// SetTokenYProgramAccount sets the "tokenYProgram" account.
func (inst *SwapWithPriceImpact) SetTokenYProgramAccount(tokenYProgram ag_solanago.PublicKey) *SwapWithPriceImpact {
	inst.AccountMetaSlice[12] = ag_solanago.Meta(tokenYProgram)
	return inst
}

// GetTokenYProgramAccount gets the "tokenYProgram" account.
func (inst *SwapWithPriceImpact) GetTokenYProgramAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(12)
}

// SetEventAuthorityAccount sets the "eventAuthority" account.
func (inst *SwapWithPriceImpact) SetEventAuthorityAccount(eventAuthority ag_solanago.PublicKey) *SwapWithPriceImpact {
	inst.AccountMetaSlice[13] = ag_solanago.Meta(eventAuthority)
	return inst
}

// GetEventAuthorityAccount gets the "eventAuthority" account.
func (inst *SwapWithPriceImpact) GetEventAuthorityAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(13)
}

// SetProgramAccount sets the "program" account.
func (inst *SwapWithPriceImpact) SetProgramAccount(program ag_solanago.PublicKey) *SwapWithPriceImpact {
	inst.AccountMetaSlice[14] = ag_solanago.Meta(program)
	return inst
}

// GetProgramAccount gets the "program" account.
func (inst *SwapWithPriceImpact) GetProgramAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(14)
}

func (inst SwapWithPriceImpact) Build() *Instruction {
	return &Instruction{BaseVariant: ag_binary.BaseVariant{
		Impl:   inst,
		TypeID: Instruction_SwapWithPriceImpact,
	}}
}
...
func (inst SwapWithPriceImpact) ValidateAndBuild() (*Instruction, error) {
...
func (inst *SwapWithPriceImpact) Validate() error {
...
func (inst *SwapWithPriceImpact) EncodeToTree(parent ag_treeout.Branches) {
	parent.Child(ag_format.Program(ProgramName, ProgramID)).
		//
		ParentFunc(func(programBranch ag_treeout.Branches) {
			programBranch.Child(ag_format.Instruction("SwapWithPriceImpact")).
				//
...
func (obj SwapWithPriceImpact) MarshalWithEncoder(encoder *ag_binary.Encoder) (err error) {
...
func (obj *SwapWithPriceImpact) UnmarshalWithDecoder(decoder *ag_binary.Decoder) (err error) {
...
// NewSwapWithPriceImpactInstruction declares a new SwapWithPriceImpact instruction with the provided parameters and accounts.
func NewSwapWithPriceImpactInstruction(
	...
	program ag_solanago.PublicKey) *SwapWithPriceImpact {
	return NewSwapWithPriceImpactInstructionBuilder().
