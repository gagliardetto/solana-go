...
// AddLiquidityOneSide is the `addLiquidityOneSide` instruction.
...
func (inst *AddLiquidityOneSide) SetLiquidityParameter(liquidityParameter LiquidityOneSideParameter) *AddLiquidityOneSide {
...
func NewAddLiquidityOneSideInstruction(
	...
	program ag_solanago.PublicKey) *AddLiquidityOneSide {
