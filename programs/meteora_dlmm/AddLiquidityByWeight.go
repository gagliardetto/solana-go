...
// AddLiquidityByWeight is the `addLiquidityByWeight` instruction.
...
func (inst *AddLiquidityByWeight) SetLiquidityParameter(liquidityParameter LiquidityParameterByWeight) *AddLiquidityByWeight {
...
func NewAddLiquidityByWeightInstruction(
	...
	program ag_solanago.PublicKey) *AddLiquidityByWeight {
