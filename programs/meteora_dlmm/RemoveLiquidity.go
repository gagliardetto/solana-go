...
func (inst *RemoveLiquidity) SetBinLiquidityRemoval(binLiquidityRemoval []BinLiquidityReduction) *RemoveLiquidity {
...
func NewRemoveLiquidityInstruction(
	...
	program ag_solanago.PublicKey) *RemoveLiquidity {
