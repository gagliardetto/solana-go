...
type GetTokenAccountsByDelegateResult struct {
	RPCContext
	Value []*TokenAccountsByDelegateResult `json:"value"`
}
type TokenAccountsByDelegateResult struct {
...
type GetTokenAccountsByDelegateOpts struct {
...
func (cl *Client) GetTokenAccountsByDelegate(
	...
	conf *GetTokenAccountsByDelegateConfig,
	opts *GetTokenAccountsByDelegateOpts,
) (out *GetTokenAccountsByDelegateResult, err error) {
