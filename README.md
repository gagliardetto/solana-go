...
[![GoDoc](https://pkg.go.dev/badge/github.com/gagliardetto/solana-go?status.svg)](https://pkg.go.dev/github.com/gagliardetto/solana-go@v1.2.1?tab=doc)
...
```bash
$ cd my-project
$ go get github.com/gagliardetto/solana-go@v1.2.1
```
