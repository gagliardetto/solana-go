...
[![GoDoc](https://pkg.go.dev/badge/github.com/gagliardetto/solana-go?status.svg)](https://pkg.go.dev/github.com/gagliardetto/solana-go@v1.9.2?tab=doc)
...
There is currently **no stable release**. The SDK is actively developed and latest is `v1.9.2` which is an `alpha` release.
...
```bash
$ cd my-project
$ go get github.com/gagliardetto/solana-go@v1.9.2
```
